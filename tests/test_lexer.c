...
test_identifier_simple(void)
{
    ...
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, "edge");
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "edge");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_EOF);
    PASS();
}
...
test_identifier_with_underscore_prefix(void)
{
    ...
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, "_tmp");
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "_tmp");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_EOF);
    PASS();
}
...
test_identifier_with_digits(void)
{
    ...
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, "node42");
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "node42");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_EOF);
    PASS();
}
...
test_identifier_with_underscores(void)
{
    ...
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, "var_points_to");
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "var_points_to");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_EOF);
    PASS();
}
...
test_standalone_underscore(void)
{
    ...
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, "_");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_UNDERSCORE);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_EOF);
    PASS();
}
...
test_integer_literal(void)
{
    ...
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, "42");
    ASSERT_TOK_VAL(lex, WL_PARSER_LEXER_TOK_INTEGER, 42);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_EOF);
    PASS();
}
...
test_integer_zero(void)
{
    TEST("integer zero");
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, "0");
    ASSERT_TOK_VAL(lex, WL_PARSER_LEXER_TOK_INTEGER, 0);
    PASS();
}
...
test_string_literal(void)
{
    TEST("string literal");
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, "\"hello world\"");
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_STRING, "hello world");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_EOF);
    PASS();
}
...
test_string_empty(void)
{
    ...
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, "\"\"");
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_STRING, "");
    PASS();
}
...
test_true_literal(void)
{
    ...
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, "True");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_TRUE);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_EOF);
    PASS();
}
...
test_false_literal(void)
{
    ...
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, "False");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_FALSE);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_EOF);
    PASS();
}
...
test_aggregate_keywords_lowercase(void)
{
    ...
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, "count sum min max average");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_COUNT);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_SUM);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_MIN);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_MAX);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_AVG);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_EOF);
    PASS();
}
...
test_aggregate_keywords_uppercase(void)
{
    ...
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, "COUNT SUM MIN MAX AVG");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_COUNT);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_SUM);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_MIN);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_MAX);
...
test_keyword_like_identifiers(void)
{
    ...
    wl_parser_lexer_init(&lex, "counter minimum int32x stringy");
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "counter");
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "minimum");
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "int32x");
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "stringy");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_EOF);
    PASS();
}
...
test_punctuation(void)
{
    ...
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, "( ) , : !");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_LPAREN);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_RPAREN);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_COMMA);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_COLON);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_BANG);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_EOF);
    PASS();
}
...
test_dot_standalone(void)
{
    ...
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, ".");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_DOT);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_EOF);
    PASS();
}
...
test_horn_clause(void)
{
    ...
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, ":-");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_HORN);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_EOF);
    PASS();
}
...
test_comparison_operators(void)
{
    ...
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, "= != < > <= >=");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_EQ);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_NEQ);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_LT);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_GT);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_LTE);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_GTE);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_EOF);
    PASS();
}
...
test_arithmetic_operators(void)
{
    ...
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, "+ - * / %");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_PLUS);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_MINUS);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_STAR);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_SLASH);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_PERCENT);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_EOF);
    PASS();
}
...
test_directive_decl(void)
{
    TEST("directive .decl");
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, ".decl");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_DECL);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_EOF);
    PASS();
}
...
test_directive_input(void)
{
    ...
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, ".input");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_INPUT);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_EOF);
    PASS();
}
...
test_directive_output(void)
{
    ...
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, ".output");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_OUTPUT);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_EOF);
    PASS();
}
...
test_directive_printsize(void)
{
    ...
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, ".printsize");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_PRINTSIZE);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_EOF);
    PASS();
}
...
test_directive_plan(void)
{
    TEST("directive .plan");
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, ".plan");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_PLAN);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_EOF);
    PASS();
}
...
test_dot_followed_by_non_directive(void)
{
    ...
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, ".foo");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_DOT);
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "foo");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_EOF);
    PASS();
}
...
test_hash_comment(void)
{
    TEST("hash comment");
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, "# this is a comment\nfoo");
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "foo");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_EOF);
    PASS();
}
...
test_double_slash_comment(void)
{
    ...
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, "// this is a comment\nbar");
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "bar");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_EOF);
    PASS();
}
...
test_comment_at_end_of_line(void)
{
    ...
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, "foo # comment\nbar");
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "foo");
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "bar");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_EOF);
    PASS();
...
test_comment_only(void)
{
    ...
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, "# just a comment");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_EOF);
    PASS();
}
...
test_line_tracking(void)
{
    ...
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, "foo\nbar\nbaz");
    wl_parser_lexer_token_t t1 = wl_parser_lexer_next_token(&lex);
    wl_parser_lexer_token_t t2 = wl_parser_lexer_next_token(&lex);
...
test_column_tracking(void)
{
    ...
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, "  foo bar");
    wl_parser_lexer_token_t t1 = wl_parser_lexer_next_token(&lex);
    wl_parser_lexer_token_t t2 = wl_parser_lexer_next_token(&lex);
...
test_peek_does_not_advance(void)
{
    ...
    char *s1 = wl_parser_lexer_token_to_string(&t1);
    char *s3 = wl_parser_lexer_token_to_string(&t3);
...
test_declaration_tokens(void)
{
    ...
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, ".decl Arc(x: int32, y: int32)");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_DECL);
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "Arc");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_LPAREN);
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "x");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_COLON);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_INT32);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_COMMA);
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "y");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_COLON);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_INT32);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_RPAREN);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_EOF);
...
test_input_directive_tokens(void)
{
    ...
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(
        &lex, ".input Arc(IO=\"file\", filename=\"Arc.csv\", delimiter=\",\")");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_INPUT);
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "Arc");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_LPAREN);
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "IO");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_EQ);
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_STRING, "file");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_COMMA);
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "filename");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_EQ);
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_STRING, "Arc.csv");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_COMMA);
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "delimiter");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_EQ);
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_STRING, ",");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_RPAREN);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_EOF);
...
test_rule_tokens(void)
{
    ...
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, "Tc(x, y) :- Arc(x, y).");
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "Tc");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_LPAREN);
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "x");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_COMMA);
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "y");
...
test_negation_tokens(void)
{
    ...
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, "r(x) :- a(x), !b(x).");
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "r");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_LPAREN);
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "x");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_RPAREN);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_HORN);
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "a");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_LPAREN);
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "x");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_RPAREN);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_COMMA);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_BANG);
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "b");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_LPAREN);
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "x");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_RPAREN);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_DOT);
...
test_aggregate_tokens(void)
{
    ...
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, "sssp(x, min(d)) :- sssp2(x, d).");
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "sssp");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_LPAREN);
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "x");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_COMMA);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_MIN);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_LPAREN);
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "d");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_RPAREN);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_RPAREN);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_HORN);
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "sssp2");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_LPAREN);
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "x");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_COMMA);
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "d");
...
test_arithmetic_in_aggregate(void)
{
    ...
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, "min(d1 + d2)");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_MIN);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_LPAREN);
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "d1");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_PLUS);
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "d2");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_RPAREN);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_EOF);
    PASS();
}
...
test_comparison_tokens(void)
{
    ...
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, "x != y, a >= 10, b < c");
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "x");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_NEQ);
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "y");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_COMMA);
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "a");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_GTE);
    ASSERT_TOK_VAL(lex, WL_PARSER_LEXER_TOK_INTEGER, 10);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_COMMA);
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "b");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_LT);
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "c");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_EOF);
    PASS();
}
...
test_wildcard_in_atom(void)
{
    ...
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, "edge(_, y)");
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "edge");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_LPAREN);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_UNDERSCORE);
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_COMMA);
...
test_plan_after_rule(void)
{
    ...
    wl_parser_lexer_t lex;
    wl_parser_lexer_init(&lex, "r(x) :- a(x). .plan");
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "r");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_LPAREN);
    ASSERT_TOK_STR(lex, WL_PARSER_LEXER_TOK_IDENT, "x");
    ASSERT_TOK(lex, WL_PARSER_LEXER_TOK_RPAREN);
