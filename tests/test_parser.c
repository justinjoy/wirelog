...
static void
test_parse_decl_string_type(void)
{
...
static void
test_parse_decl_three_attrs(void)
{
...
static void
test_parse_input_directive(void)
{
    ...
    if (p0->type != WL_PARSER_AST_NODE_INPUT_PARAM
        || strcmp(p0->name, "IO") != 0 || strcmp(p0->str_value, "file") != 0) {
        CLEANUP();
...
static void
test_parse_printsize_directive(void)
{
    TEST(".printsize directive");
    PARSE(".printsize Tc");
    ASSERT_PARSED();
    const wl_parser_ast_node_t *ps = child(program, 0);
    if (ps->type != WL_PARSER_AST_NODE_PRINTSIZE
        || strcmp(ps->name, "Tc") != 0) {
        CLEANUP();
...
static void
test_parse_recursive_rule(void)
{
...
static void
test_parse_rule_with_constants(void)
{
...
static void
test_parse_rule_with_string_constant(void)
{
    ...
    const wl_parser_ast_node_t *body = child(rule, 1);
    const wl_parser_ast_node_t *arg1 = child(body, 1);
    if (arg1->type != WL_PARSER_AST_NODE_STRING
...
static void
test_parse_rule_with_wildcard(void)
{
...
test_parse_negation(void)
{
    ...
    if (inner->type != WL_PARSER_AST_NODE_ATOM
...
static void
test_parse_equality_constraint(void)
{
    ...
    if (cmp->type != WL_PARSER_AST_NODE_COMPARISON
...
static void
test_parse_inequality_constraint(void)
{
...
static void
test_parse_arithmetic_comparison(void)
{
    ...
    if (left->type != WL_PARSER_AST_NODE_BINARY_EXPR
        || left->arith_op != WIRELOG_ARITH_ADD) {
        CLEANUP();
...
static void
test_parse_count_aggregate(void)
{
...
test_parse_aggregate_with_arithmetic(void)
{
    ...
    if (expr->type != WL_PARSER_AST_NODE_BINARY_EXPR
        || expr->arith_op != WIRELOG_ARITH_ADD) {
        CLEANUP();
...
static void
test_parse_aggregate_with_constant(void)
{
...
static void
test_parse_arithmetic_head(void)
{
    ...
    if (arg0->type != WL_PARSER_AST_NODE_BINARY_EXPR
        || arg0->arith_op != WIRELOG_ARITH_ADD) {
        CLEANUP();
...
static void
test_parse_rule_without_plan(void)
{
...
static void
test_parse_transitive_closure(void)
{
...
test_parse_sssp(void)
{
    ...
    if (arith->type != WL_PARSER_AST_NODE_BINARY_EXPR
...
static void
test_parse_negation_program(void)
{
...
static void
test_parse_comparison_program(void)
{
...
test_parse_fact_string_constant(void)
{
    ...
    if (child(fact, 1)->type != WL_PARSER_AST_NODE_STRING
        || !child(fact, 1)->str_value
...
static void
test_parse_error_missing_horn(void)
{
...
static void
test_parse_error_missing_dot(void)
{
...
static void
test_parse_error_missing_rparen(void)
{
...
static void
test_parse_error_invalid_type(void)
{
...
static void
test_parse_all_arithmetic_ops(void)
{
