...
struct wirelog_ir_node {
    ...
    wl_ir_expr_t **project_exprs; /* PROJECT: expressions (for computed columns) */
...
wirelog_ir_node_t *wl_ir_node_create(wirelog_ir_node_type_t type);
void               wl_ir_node_set_relation(wirelog_ir_node_t *node, const char *name);
void               wl_ir_node_add_child(wirelog_ir_node_t *node, wirelog_ir_node_t *child);
void               wl_ir_node_free(wirelog_ir_node_t *node);

/* ======================================================================== */
/* Expression API (internal)                                                */
/* ======================================================================== */

wl_ir_expr_t *wl_ir_expr_create(wl_ir_expr_type_t type);
void          wl_ir_expr_add_child(wl_ir_expr_t *parent, wl_ir_expr_t *child);
void          wl_ir_expr_free(wl_ir_expr_t *expr);
